...
def get_videos():
    ...
    """
    while True:
        path = click.prompt("Enter your file path names (separated by commas)", type=str)
...
def process_single_tiff(full_path, parent_dir, my_folders, outputs, output_type, isolated_answer: bool = False):
    """
...
def main():
    ...
    for full_path in list_of_paths:
        os.chdir(parent_dir)
        process_single_tiff(full_path, parent_dir, my_folders, outputs, output_type, isolated_answer)
